...
function organic_green_blocks_custom_admin_notice() {
    ...
    if (!get_user_meta(get_current_user_id(), 'dismissed_admin_notice', true)) {
        ...
        if ($current_screen && $current_screen->id !== 'appearance_page_organic-green-blocks-guide-page') {
            $theme = wp_get_theme();
            ?>
...
function organic_green_blocks_enqueue_admin_script($hook) {
    ...
    wp_enqueue_style('organic-green-blocks-dashboard-css', get_theme_file_uri('/inc/dashboard/dashboard.css'));
