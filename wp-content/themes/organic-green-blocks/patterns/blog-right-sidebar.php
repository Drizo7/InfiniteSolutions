 ...
 * Slug: organic-green-blocks/blog-right-sidebar
 * Categories: organic-green-blocks, blog-right-sidebar
 */
?>
...
<h3 class="wp-block-heading has-text-align-center"><?php esc_html_e('Sorry, no post exist...','organic-green-blocks'); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"organic-green-blocks","area":"uncategorized"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->